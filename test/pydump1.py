...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/l/lata/public/941021E6-1FCF-E511-969E-FA163E8CF0DE.root')
)
...
process.updatedPatJetsTransientCorrected = cms.EDProducer("PATJetUpdater",
    ...
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfTrackCountingHighEffBJetTags"), cms.InputTag("pfTrackCountingHighPurBJetTags"), cms.InputTag("pfJetProbabilityBJetTags"), cms.InputTag("pfJetBProbabilityBJetTags"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTags"), 
        cms.InputTag("pfSimpleSecondaryVertexHighPurBJetTags"), cms.InputTag("pfCombinedSecondaryVertexV2BJetTags"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTags"), cms.InputTag("pfCombinedMVAV2BJetTags"), cms.InputTag("pfDeepCSVJetTags","probb"), 
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfos"), cms.InputTag("pfSecondaryVertexTagInfos"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfos"), cms.InputTag("softPFMuonsTagInfos"), cms.InputTag("softPFElectronsTagInfos"), 
        cms.InputTag("pfDeepCSVTagInfos")),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.bTaggingExerciseIPartII = cms.EDAnalyzer("BTaggingExerciseI",
    bDiscriminators = cms.vstring('pfTrackCountingHighEffBJetTags', 
...
process.out = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring('keep *_*_*_User', 
        'keep *_selectedUpdatedPatJets_*_*')
)
